    ...
    <header className="sticky top-0 z-20 border-b border-navy/10 bg-white/85 backdrop-blur-md">
      <div className="flex items-center gap-3 px-4 py-3.5 sm:px-6 lg:px-8">
        ...
        <div className="min-w-0 flex-1">
          ...
          <h1 className="truncate text-lg font-extrabold tracking-tight text-navy sm:text-xl">
            {active === 'about'
        ...
        {/* Year legend */}
        <div className="hidden items-center gap-3 rounded-xl border border-navy/10 bg-mist/60 px-3 py-2 md:flex">
          <CalendarDays className="h-4 w-4 text-navy/50" />
      ...
      {/* Context strip */}
      <div className="flex flex-wrap items-center gap-x-5 gap-y-1 border-t border-navy/5 bg-mist/40 px-4 py-2 text-xs text-ink/60 sm:px-6 lg:px-8">
